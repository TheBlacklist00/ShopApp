...
public class SellerAddNewProductActivity extends AppCompatActivity {
    ...
    private void ValidateProductData()
    {
        ...
        if (ImageUri == null)
        {
            Toast.makeText(this, "Veuillez entrer l'image du produit...", Toast.LENGTH_SHORT).show();
        }
    ...
    private void StoreProductInformation()
    {
        ...
        loadingBar.setMessage("Veuillez patienter pendant l'ajout du produit");
        ...
        uploadTask.addOnFailureListener(new OnFailureListener() {
            ...
            public void onFailure(@NonNull Exception e)
            {
                ...
                Toast.makeText(SellerAddNewProductActivity.this, "Erreur: " + message, Toast.LENGTH_SHORT).show();
                loadingBar.dismiss();
            }
            ...
            {
                Toast.makeText(SellerAddNewProductActivity.this, "L'image du produit a été ajouté avec succès", Toast.LENGTH_SHORT).show();
                ...
                Task<Uri> urlTask = uploadTask.continueWithTask(new Continuation<UploadTask.TaskSnapshot, Task<Uri>>() {
                    ...
                    public void onComplete(@NonNull Task<Uri> task)
                    {
                        if (task.isSuccessful())
                        {
                            ...
                            Toast.makeText(SellerAddNewProductActivity.this, "L'url de l'image a été reçu avec succès...", Toast.LENGTH_SHORT).show();
                ...
                .addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task)
                    {
                        if (task.isSuccessful())
                        {
                            ...
                            loadingBar.dismiss();
                            Toast.makeText(SellerAddNewProductActivity.this, "Product ajouté avec succès..", Toast.LENGTH_SHORT).show();
                        }
                        else
                        {
                            loadingBar.dismiss();
